...
namespace Logbook
{
    class MSRadioButton : RadioButton
    {
        //Fields
        ...
        {
            this.MinimumSize = new Size(0, 10);
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            using (SolidBrush brushText = new SolidBrush(this.ForeColor))
            {
                ...
                graphics.DrawString(this.Text, this.Font, brushText,
                    rbBorderSize + 2, (this.Height - TextRenderer.MeasureText(this.Text, this.Font).Height) / 2 + 1);//Y=Center
            }
        }
